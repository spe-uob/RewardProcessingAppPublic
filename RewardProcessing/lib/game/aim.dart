          ...
          Column(mainAxisAlignment: MainAxisAlignment.center, children: <
            ...
            Container(
                ...
                child: RichText(
                    text: const TextSpan(
                        style:
                            TextStyle(color: Colors.blue), //apply style to all
                        children: [
                      TextSpan(
            ...
            Container(
                ...
                child: RichText(
                    text: const TextSpan(
                      ...
                      TextSpan(
                          text:
                              'Each cherry will earn you some points and you need to get',
                          style: TextStyle(fontSize: 16, color: Colors.black)),
                      TextSpan(
            ...
            Container(
                margin: const EdgeInsets.only(
                    right: 50, left: 50, top: 10, bottom: 10),
                child: const Text(
                    'You will learn how to better find cherries the more you play the game.',
                    textAlign: TextAlign.center,
                    overflow: TextOverflow.visible,
                    style: TextStyle(fontSize: 16, color: Colors.black))),
            Container(
                margin: const EdgeInsets.only(
                    right: 50, left: 50, top: 10, bottom: 30),
                ...
                child: ElevatedButton(
                    onPressed: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const GameFinished()));
                    },
