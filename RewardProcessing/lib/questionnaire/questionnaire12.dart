...
import 'package:rewardprocessing/questionnaire/MySlider.dart';
import 'package:rewardprocessing/questionnaire/questionnaire13.dart';
                  ...
                  child: Container(
                      ...
                      child: Container(
                          ...
                          child: const Text(
                              ...
                              style: TextStyle(
                                  fontSize: 19, letterSpacing: 0.75))))),
              SliderTheme(
                      ...
                      onPressed: activeButton
                          ? () async {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          Questionnaire13(id: widget.id)));
                              await FirebaseFirestore.instance
                                  .collection('questionnaire')
                                  .doc(widget.id)
                                  .set({
                                '12. Restless/Calm (-3/3)': _currentSliderValue
