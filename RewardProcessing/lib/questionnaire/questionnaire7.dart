...
import 'package:rewardprocessing/questionnaire/questionnaire8.dart';
...
class Questionnaire7 extends StatefulWidget {
  final String id;
  const Questionnaire7({super.key, required this.id});
                      ...
                      onPressed: activeButton
                          ? () async {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          Questionnaire8(id: widget.id)));
                              await FirebaseFirestore.instance
                                  .collection('questionnaire')
                                  .doc(widget.id)
                                  .set({
                                '7. Hopeless/Hopeful (-3/3)':
                                    _currentSliderValue
