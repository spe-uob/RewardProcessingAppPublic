...
import 'package:rewardprocessing/questionnaire/questionnaire5.dart';
            ...
            body:
              ...
              Row(
                  ...
                  children: <Widget>[
                    ...
                    Container(
                        margin: const EdgeInsets.only(left: 260, right: 10),
                      ...
                      onPressed: activeButton
                          ? () async {
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) =>
                                          Questionnaire5(id: widget.id)));
                              await FirebaseFirestore.instance
                                  .collection('questionnaire')
                                  .doc(widget.id)
                                  .set({
                                '4. Guilty/Proud (-3/3)': _currentSliderValue
